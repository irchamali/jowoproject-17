        ...
        <div class="container" >
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-5 text-center py-4 py-sm-0" data-aos="fade-down"> 
                    <img class="img-fluid" src="frontend/assets/images/about.jpg" alt="about" >
                </div>
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </section> 
        ...
        <div class="container-fluid text-light">
            <div class="row">
                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right">
                    <img class="img-fluid" src="frontend/assets/images/work.jpg" alt="work">        
                </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card p-4">
                                        ...
                                        <div class="d-flex pt-4">
                                            <div>
                                                <img class="avatar" src="frontend/assets/images/testimonial-1.jpg" alt="testimonial">
                                            </div>
                                            <div class="ms-3 pt-2">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card p-4">
                                        ...
                                        <div class="d-flex pt-4">
                                            <div>
                                                <img class="avatar" src="frontend/assets/images/testimonial-2.jpg" alt="testimonial">
                                            </div>
                                            <div class="ms-3 pt-2">
                                                <h6>John Spiker</h6>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card p-4">
                                        ...
                                        <div class="d-flex pt-4">
                                            <div>
                                                <img class="avatar" src="frontend/assets/images/testimonial-3.jpg" alt="testimonial">
                                            </div>
                                            <div class="ms-3 pt-2">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card p-4">
                                        ...
                                        <div class="d-flex pt-4">
                                            <div>
                                                <img class="avatar" src="frontend/assets/images/testimonial-4.jpg" alt="testimonial">
                                            </div>
                                            <div class="ms-3 pt-2">
                                                <p>Mike tim</p>
    ...
    <section class="contact d-flex align-items-center py-5" id="contact">
        <div class="container-fluid text-light">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-down">
                    <img class="img-fluid d-none d-lg-block" src="frontend/assets/images/contact.jpg" alt="contact">        
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </section> 
